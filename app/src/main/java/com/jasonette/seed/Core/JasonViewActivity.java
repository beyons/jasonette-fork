                ...
                if(header.has("search")){
                    ...
                    if (searchView == null) {
                        ...
                        if(search.has("style") && search.getJSONObject("style").has("color")){
                            int c = JasonHelper.parse_color(search.getJSONObject("style").getString("color"));
                            ImageView searchIcon = searchView.findViewById(R.id.search_button);
                            searchIcon.setColorFilter(c);
                            EditText txtSearch = ((EditText)searchView.findViewById(androidx.appcompat.R.id.search_src_text));
                            txtSearch.setHintTextColor(c);
                            txtSearch.setTextColor(c);
                        }
